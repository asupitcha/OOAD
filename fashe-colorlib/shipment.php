			...
			<div class="container-table-cart pos-relative">
				<div class="wrap-table-shopping-cart bgwhite">
					<table class="table-shopping-cart">
						<tr class="table-head">
							<th class="column-1"style="width: 300px;"></th>
							<th class="column-2"style="width: 300px;">Order Number</th>
							<th class="column-3"style="width: 300px;">Status</th>
							<th class="column-4"style="width: 300px;">Tracking</th>
						</tr>
						<tr class="table-row">
							<td class="column-1"></td>
							<td class="column-2">Order Number</th>
							<td class="column-3">จัดส่งแล้ว</td>
							<td class="column-4">12345678</td>
						</tr>
					</table>
				</div>
			</div>
